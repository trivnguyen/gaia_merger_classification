...
# 0.5 * LR / EPCOCHS / len(TrainingData)

filepath = "saved_models/LargeSet_AccretedVirialized5DPhot-{epoch:02d}-{val_loss:.2f}.hdf5"
...
es = EarlyStopping(monitor='val_loss', patience=6, verbose=0, mode='auto')
...
model.save('saved_models/LargeSet_AccretedVirialized5DPhot_0.h5')
...
model.save('saved_models/LargeSet_AccretedVirialized5DPhot.h5')
...
plt.title('Validation Accreted Virialized 5DPhot [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirialized5DPhot_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized 5DPhot [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirialized5DPhot_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_AllStars_AccretedVirialized5DPhot_ROC_Curve.pdf',
            bbox_inches='tight'
            )
