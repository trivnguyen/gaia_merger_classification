...
with open('../data/MeansAndVariance.txt') as f:
    for line in f:
        ...
        if line[0] == 'distance':
            ...
            normstatistics.append([distance_mean, distance_std])
        if line[0] == 'pmra_true':
...
model = load_model('saved_models/UsingDistanceTrue_NoRegLRPlateau.h5') # The model
...
# plt.yscale('log')
# plt.savefig('../plots/TrueDistance_NoRegLRPlateau_Validation_NNout_MinLoss.pdf',
#             bbox_inches='tight'
#             )
#
# plt.figure(figsize=(4,4))
...
# plt.ylabel('Stars per bin')
# plt.yscale('log')
# plt.savefig('../plots/TrueDistance_NoRegLRPlateau_Test_NNout_MinLoss.pdf',
#             bbox_inches='tight'
#             )

plt.figure(figsize=(4,4))
plt.hist(Test_Preds[Test_Labels==0], bins=20, range=(0.98,1), histtype='step')
plt.hist(Test_Preds[Test_Labels==1], bins=20, range=(0.98,1), histtype='step')
plt.plot([],[], color='C0', label='Non halo')
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test data (True distance)')
...
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/TrueDistance_NoRegLRPlateau_Test_NNout_zoomed.pdf',
            bbox_inches='tight'
            )
...
# plt.savefig('../plots/TrueDistance_NoRegLRPlateau_ROC_Curve_MinLoss.pdf',
#             bbox_inches='tight'
#             )
