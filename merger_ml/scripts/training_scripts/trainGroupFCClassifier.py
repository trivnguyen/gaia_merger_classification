...
from merger_ml.modules import group_fc_nn
...
def parse_cmd():
    ...
    parser.add_argument(
        ...
        help='Enable to start tuning mode. ' +
            'Overwrite lr, hidden_layers with random values drawn from a fix distribution.')
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    if FLAGS.tuning:
        ...
        rvars = {}
        rvars['lr'] = FLAGS.lr
        rvars['hidden_layers'] = FLAGS.hidden_layers
    ...
    net = gr_fc_nn.GroupFCNetwork(input_dims, hidden_layers=FLAGS.hidden_layers)
