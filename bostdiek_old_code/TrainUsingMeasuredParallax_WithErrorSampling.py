...
filepath = "saved_models/UsingParallaxMeasured_AllStars_ErrorSampling-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/UsingParallaxMeasured_AllStars_ErrorSampling.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_UsingParallaxMeasured_AllStars_ErrorSampling.pdf', bbox_inches='tight')
...
plt.title('Validation data (Measured Parallax) [AllStars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/UsingParallaxMeasured_AllStars_ErrorSampling_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test data (Measured Parallax) [AllStars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/UsingParallaxMeasured_AllStars_ErrorSampling_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/UsingParallaxMeasured_AllStars_ErrorSampling_ROC_Curve.pdf',
            bbox_inches='tight'
            )
