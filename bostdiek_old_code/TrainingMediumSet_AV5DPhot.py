...
filepath = "saved_models/MediumSet_AV5DPhot_{epoch:02d}_{lr:.5f}_{val_loss:.2f}.hdf5"
...
model.save('saved_models/MediumSet_AV5D.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_MediumSet_AV5D.pdf',
            bbox_inches='tight')
...
plt.title('Validation Accreted Virialized 5DPhot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MediumSet_AV5DPhot_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized 5DPhot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MediumSet_AV5DPhot_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MediumSet_AV5DPhot_ROC_Curve.pdf',
            bbox_inches='tight'
            )
