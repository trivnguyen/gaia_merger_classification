...
filepath = "saved_models/SmallSet_AccretedVirializedFourDFeH-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/SmallSet_AccretedVirializedFourDFeH_5.h5')
...
plt.title('Measured Parallax [small errors] Accreted VirializedFourDFeH')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_SmallSet_AccretedVirializedFourDFeH_5.pdf',
            bbox_inches='tight')
...
plt.title('Validation Accreted Virialized FourDFeH (Measured Parallax) [Small errors]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_SmallSet_AccretedVirializedFourDFeH_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized FourDFeH (Measured Parallax) [Small errors]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_SmallSet_AccretedVirializedFourDFeH_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_SmallSet_AccretedVirializedFourDFeH_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
