...
filepath = "saved_models/Medium5D-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/Medium5D_ES.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_MP_SMallErrors_ErrorSampling_AccretedVirializedFourD_5.pdf',
            bbox_inches='tight')
...
plt.yscale('log')
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_AccretedVirializedFourD_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_AccretedVirializedFourD_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_AccretedVirializedFourD_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
