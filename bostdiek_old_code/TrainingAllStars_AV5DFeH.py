...
filepath = "saved_models/LargeSet5DFeH-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/LargeSet5DFeH.h5')
...
plt.title('Measured Parallax [All Stars] Accreted VirializedFiveDFeH')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_AllStars_AccretedVirializedFiveDFeH_5.pdf',
            bbox_inches='tight')
...
plt.title('Validation Accreted Virialized FiveDFeH (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveDFeH_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized FiveDFeH (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveDFeH_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveDFeH_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
