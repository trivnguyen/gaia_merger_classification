...
BATCHSIZE = int(TotalStars / NumHalo * 2)
...
with open('../data/MeansAndVariance.txt') as f:
    for line in f:
        ...
        #     normstatistics[4] = [feh_mean, feh_std]
...
filepath = "saved_models/SmallSet_4DPhot_{epoch:02d}_{val_loss:.2f}_{lr:.05f}.hdf5"
...
model.save('saved_models/SmallSet_4DPhot_AV.h5')
...
plt.title('Small set 4D+Phot')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_SmallSet_4DPhot.pdf',
            bbox_inches='tight')
...
plt.title('Validation SmallSet 4D +Phot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/SmallSet_4DPhot_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Small set 4D+Phot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/SmallSet_4DPhot_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/SmallSet_4DPhot_ROC_Curve.pdf',
            bbox_inches='tight'
            )
