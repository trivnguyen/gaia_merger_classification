...
filepath = "saved_models/SmallSet_FiveDPhot-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/SmallSet_FiveDPhot_AV.h5')
...
plt.title('Small set 5D+Phot')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_SmallSet_FiveDPhot.pdf',
            bbox_inches='tight')
...
plt.title('Validation SmallSet FiveD +Phot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/SmallSet_FiveDPhot_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Small set 5D+Phot')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/SmallSet_FiveDPhot_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/SmallSet_FiveDPhot_ROC_Curve.pdf',
            bbox_inches='tight'
            )
