...
filepath = "saved_models/LargeSet4D-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/LargeSet4D_0.h5')
...
model.save('saved_models/LargeSet4D.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_AllStars_AccretedVirializedFourD_5.pdf',
            bbox_inches='tight')
...
plt.title('Validation Accreted Virialized FourD (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFourD_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized FourD (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFourD_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_AllStars_AccretedVirializedFourD_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
