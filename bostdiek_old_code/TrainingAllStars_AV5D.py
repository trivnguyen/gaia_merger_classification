...
filepath = "saved_models/LargeSet5D-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/LargeSet5D_0.h5')
...
model.save('saved_models/LargeSet5D.h5')
...
plt.title('Validation Accreted Virialized FiveD (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveD_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized FiveD (Measured Parallax) [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveD_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_AllStars_AccretedVirializedFiveD_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
