...
from MyDataGenerators import DataGeneratorWithMetallicity as DataGenerator
...
HaloLabels = np.load('../data/StarLabels_accreted.npy')
ltrue = np.load('../data/sliced_l_true.npy')
btrue = np.load('../data/sliced_b_true.npy')
parallax = np.load('../data/sliced_parallax_true.npy')
pmra = np.load('../data/sliced_pmra_true.npy')
pmdec = np.load('../data/sliced_pmdec_true.npy')
...
filepath = "saved_models/UltimateNetwork_A-{epoch:02d}-{val_loss:.2f}.hdf5"
...
# model = load_model('saved_models/UltimateNetwork.h5')
...
model.save('saved_models/UltimateNetwork_A.h5')
...
plt.title('(Truth level + [Fe/H]) [Small error stars]')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_UltimateNetwork_A.pdf', bbox_inches='tight')
...
plt.title('Validation data (Truth level + [Fe/H]) [Small error stars] Accreted')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/UltimateNetwork_A_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test data (Truth level + [Fe/H]) [Small error stars] Accreted')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/UltimateNetwork_A_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/UltimateNetwork_A_ROC_Curve.pdf',
            bbox_inches='tight'
            )
