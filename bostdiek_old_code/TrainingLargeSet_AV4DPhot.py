...
EPCOCHS = 50
LR = 0.001
LRDECAY = 1.0/np.power(np.sqrt(0.1), 3e-5) - 1

filepath = "saved_models/LargeSet_AccretedVirialized4DPhot-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/LargeSet_AccretedVirialized4DPhot_0.h5')
...
model.save('saved_models/LargeSet_AccretedVirialized4DPhot.h5')
...
plt.title('Measured Parallax [All Stars] Accreted VirializedFourD')
plt.legend(loc='best', frameon=False, fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_AllStars_AccretedVirialized4DPhot.pdf',
            bbox_inches='tight')
...
plt.title('Validation Accreted Virialized FourDPhot [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirialized4DPhot_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted Virialized FourDPhot [All Stars]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_AllStars_AccretedVirialized4DPhot_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_AllStars_AccretedVirialized4DPhot_ROC_Curve.pdf',
            bbox_inches='tight'
            )
