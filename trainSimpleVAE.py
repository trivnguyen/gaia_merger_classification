...
def parse_cmd():
    ...
    parser.add_argument('-d','--latent-dims', required=True, type=int, default='5D',
...
if __name__ == '__main__':
    ...
    net = simple_vae.SimpleVAE(input_dims, FLAGS.latent_dims)
    ...
    train_log = classifier_logger.ClassifierLogger(
        out_dir=FLAGS.out_dir, metrics=['kld_loss', 'mse_loss'])
