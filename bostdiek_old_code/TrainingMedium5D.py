...
filepath = "saved_models/MediumPoint_ES_AV5D_5-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/MediumPoint_ES_AV5D.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_MediumPoint_AV5D.pdf',
            bbox_inches='tight')
...
plt.yscale('log')
plt.savefig('../plots/MediumPoint_AV5D_5_Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MediumPoint_AV5D_5_Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MediumPoint_AV5D_5_ROC_Curve.pdf',
            bbox_inches='tight'
            )
