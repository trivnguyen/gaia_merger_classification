...
filepath = "saved_models/MP_SMallErrors_ErrorSampling_Accreted_5-{epoch:02d}-{val_loss:.2f}.hdf5"
...
model.save('saved_models/MP_SMallErrors_ErrorSampling_Accreted_5.h5')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('../plots/History_MP_SMallErrors_ErrorSampling_Accreted_5.pdf', bbox_inches='tight')
...
plt.title('Validation Accreted (Measured Parallax) [Small errors]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_Accreted_5Validation_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.plot([],[], color='C1', label='Halo')
plt.legend(loc='best', frameon=False)
plt.title('Test Accreted (Measured Parallax) [Small errors]')
plt.xlabel('Network output')
plt.ylabel('Stars per bin')
plt.yscale('log')
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_Accreted_5Test_NNout.pdf',
            bbox_inches='tight'
            )
...
plt.savefig('../plots/MP_SMallErrors_ErrorSampling_Accreted_5ROC_Curve.pdf',
            bbox_inches='tight'
            )
